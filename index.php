                            ...
                            <div class="row topic">
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    <div class="media my-1 p-1 text-md-left text-sm-right">
                                        <img src="img/profile_images/user_default_green.png" style="width:40px;height:40px;" alt="User Avatar"
                ...
                <div class="card border-0">
                    ...
                    <div class="card-body">
                        ...
                        <div class="media mb-3">
                            <img src="img/profile_images/user_default_red.png" style="width:40px;height:40px;" alt="" class="d-flex mr-3 align-self-center">
                            <div class="media-body">
